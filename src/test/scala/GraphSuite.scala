...
//  }
  ...
  test("83b find all spanning trees for the bigger graph given in the problem statement") {
    val g = Graph.term(
      List('a, 'b, 'c, 'd),
      List(('a, 'b), ('b, 'c), ('c, 'd), ('d, 'a), ('d, 'b)))
    g.spanningTrees.size shouldBe 8
  }

  test("83d find all spanning trees for the bigger graph given in the problem statement") {
    val g = Graph.term(
      List('a, 'b, 'c, 'd),
      List(('a, 'b), ('b, 'c), ('c, 'd), ('d, 'a), ('d, 'b), ('a, 'c)))
    g.spanningTrees.size shouldBe 16
  }

  test("83c find all spanning trees for the bigger graph given in the problem statement 5^3") {
    val g = Graph.term(
      List('a, 'b, 'c, 'd, 'e),
      List(('a, 'b), ('a, 'c), ('a, 'd), ('a, 'e), ('b, 'c), ('c, 'd), ('d, 'e), ('e, 'b), ('e, 'c), ('b, 'd)))
